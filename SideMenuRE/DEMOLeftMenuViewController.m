...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSArray *titles = @[@"My Profile", @"My Reviews", @"My Wishlist", @"My Address", @"Notification",@"Setting",@"Sign out"];
    NSArray *images = @[@"IconHome", @"IconCalendar", @"IconProfile", @"IconSettings", @"IconHome", @"IconSettings", @"IconCalendar"];
